                ...
                <div class="card-body">
                    <form action="{{ route('tests.store') }}" method="post">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-6">
                                <input type="date" class="form-control @error('test_date') is-invalid @enderror" id="test_date" name="test_date" value="{{ old('test_date') }}">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-6">
                                <input type="location" class="form-control @error('test_date') is-invalid @enderror" id="location" name="location" value="{{ old('location') }}">
                        ...
                        <div class="mb-3 row">
                            <input type="submit" class="col-md-3 offset-md-5 btn btn-primary" value="Add Test">
                        </div>
