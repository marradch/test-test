        ...
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @if($test->score)
                        <div class="row">
                            <label class="col-md-4 col-form-label text-md-end text-start"><strong>Score</strong></label>
                            <div class="col-md-6" style="line-height: 35px;">
                                {{ $test->score }}
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <label class="col-md-4 col-form-label text-md-end text-start"><strong>Criteria</strong></label>
                            <div class="col-md-6" style="line-height: 35px;">
                                {{ $test->criterion }}
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <label class="col-md-4 col-form-label text-md-end text-start"><strong>Manager</strong></label>
                            <div class="col-md-6" style="line-height: 35px;">
                                {{ $test->manager->name }}
                            </div>
                        </div>
